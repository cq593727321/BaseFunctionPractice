package com.cq.customview.widget;
...
import com.cq.customview.util.ThemeUtils;

import java.util.ArrayList;
import java.util.List;

import static com.cq.customview.R.styleable.MainNavigateTabBar_navigateTabTextColor;


public class MyNavigateTabBar extends LinearLayout implements View.OnClickListener {
    ...
    public MyNavigateTabBar(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
    }

    public MyNavigateTabBar(Context context) {
        this(context, null);
    }

    public MyNavigateTabBar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MyNavigateTabBar(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        TypedArray typedArray = context.getTheme().obtainStyledAttributes(attrs, R.styleable.MainNavigateTabBar, 0, 0);

        ColorStateList tabTextColor = typedArray.getColorStateList(MainNavigateTabBar_navigateTabTextColor);
